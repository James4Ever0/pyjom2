...
parser = argparse.ArgumentParser(
    description="Command line program for registering video and viewing statistics"
)
...
register_video_parser.add_argument(
    "--project_path", type=str, required=True, help="Path to the project"
)
register_video_parser.add_argument(
...
register_video_parser.add_argument(
    "--platform", type=str, required=True, help="Platform for the video"
)
register_video_parser.add_argument(
    "--url", type=str, required=True, help="URL for the video"
)

# Subparser for 'view_statistics'
view_statistics_parser = subparsers.add_parser(
    "view_statistics", help="View video statistics"
)
view_statistics_parser.add_argument(
    "--platform", type=str, required=True, help="Platform for the statistics"
)
view_statistics_parser.add_argument(
    "--show", type=str, nargs="+", required=True, help="Fields to show"
)
